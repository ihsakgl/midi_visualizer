...
class Background:
    ...
    def render(self, delta_time, current_time):
        ...
        assert self.background_texture_a.glo != self.background_fbo_b.color_attachments[0].glo, "Texture A should not be attached to FBO B"
        self.ctx.enable(moderngl.BLEND)
        ...
        self.fade_program['decayK'].value = r
        ...
        self.smoke_program['smokeColor1'].value = tuple(self.smoke_color1)
        self.smoke_program['smokeColor2'].value = tuple(self.smoke_color2)
        ...
        self.smoke_program['sigma'].value = sigma
